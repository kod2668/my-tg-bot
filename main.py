...
# Configure Gemini Client (SDK အသစ်)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if "429" in error_msg or "quota" in error_msg.lower():
            await update.message.reply_text("⚠️ API Quota ခဏပြည့်သွားပါသည် (တစ်မိနစ် ၅ ကြိမ်သာ Free သုံးလို့ရပါ၍)။ ကျေးဇူးပြု၍ ခဏစောင့်ပြီးမှ ထပ်မေးပေးပါ Boss။")
        else:
