...
def api_chat():
    ...
    image_keywords = ["generate image", "create image", "draw", "painting", "photo of", "ပုံဖန်တီး", "ပုံဆွဲ", "ပုံထုတ်"]
    ...
    # Model နှင့် System Instruction သတ်မှတ်ခြင်း (Boss ပေးထားသည့်အတိုင်း)
    if is_owner:
