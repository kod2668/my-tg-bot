...
def api_chat():
    ...
    # ==================== AI IMAGE GENERATION HANDLING (Nano Banana Models via generate_content) ====================
    ...
    if is_asking_for_image and not file_data:
        def generate_image_response():
            try:
                ...
                # generate_content ကို အသုံးပြု၍ ပုံထုတ်ခြင်း (Deprecated ဖြစ်သော generate_images အစား)
                ...
                # ရလာဒ်ထဲမှ ပုံဒေတာကို ထုတ်ယူပြီး Base64 ဖြင့် ပြန်လည်ပေးပို့ခြင်း
                image_bytes = None
