...
# Initialize Flask for Keep-Alive & Backend API
app = Flask(__name__)
CORS(app)
...
# API Endpoint for App Connection with Streaming Support
...
def api_chat():
    ...
    # ⭐ အရေးကြီးချက်: App စဖွင့်ချင်း Initial Check လုပ်တာဖြစ်ရင် Tier ကို JSON နဲ့ ချက်ချင်း ပြန်ပေးရန်
    if prompt == "check_status_init":
        return jsonify({"tier": tier})

    # Set System Instructions & Safety Settings based on Tier
    if tier == "boss":
        system_instruction = (
