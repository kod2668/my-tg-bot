    ...
    if is_asking_for_image and not file_data:
        def generate_image_response():
            try:
                ...
                # Pollinations.ai ကို အသုံးပြု၍ ပုံထုတ်ခြင်း (nologo=true ထည့်ထားသဖြင့် ပုံပေါ်ကစာသားပါ ပျောက်မည်)
                image_url = f"https://image.pollinations.ai/prompt/{safe_prompt}?width=1024&height=1024&nologo=true"
                
                # အောက်မှာ Prompt စာသား မပါတော့ဘဲ ပုံသီးသန့် Markdown ကိုသာ ထုတ်ပေးမည်
